  ...
  useEffect(() => {
    ...
    const init = async () => {
      try {
        ...
        const RendererClass = ogl.Renderer;
        const ProgramClass = ogl.Program;
        const MeshClass = ogl.Mesh;
        const TriangleClass = ogl.Triangle;
        const Vec3Class = ogl.Vec3;
        ...
        const geometry = new TriangleClass(glContext);
        program = new ProgramClass(glContext, {
          vertex: vert,
          fragment: frag,
          uniforms: {
            iTime: { value: 0 },
        ...
        const mesh = new MeshClass(glContext, { geometry, program });
